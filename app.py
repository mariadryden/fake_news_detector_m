...
def page_prediction():
    st.markdown('''
                ##### All you need to do is input the body of the article below (without websites, titles, ads, or authors) and the detector will return a prediction, as well as its respective probability.
                ''')

    st.markdown("""
        <style>
        .stTextArea [data-baseweb=base-input] {
            background-image: linear-gradient(140deg, rgb(230, 200, 230) 0%, rgb(200, 160, 200) 50%, rgb(180, 140, 180) 75%);
